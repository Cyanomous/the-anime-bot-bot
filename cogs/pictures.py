...
class pictures(commands.Cog):
  ...
  async def gradiant(self, ctx):
    ...
    await ctx.send(embed=embed, file=image)
  @commands.command()
  async def amiajoke(self, ctx, thing: typing.Optional[typing.Union[discord.Member, discord.PartialEmoji, discord.Emoji, str]], level:float=0.3):
  ...
  async def archieve(self, ctx, *, text):
    ...
    await ctx.send(embed=embed, file=image)
  @commands.command()
  async def pixelate(self, ctx, thing: typing.Optional[typing.Union[discord.Member, discord.PartialEmoji, discord.Emoji, str]], level:float=0.3):
    async with ctx.channel.typing():
      if level > 1:
        level = 1
      if thing == None:
  ...
  @commands.command()
  async def threshold(self, ctx, thing: typing.Union[discord.Member, discord.PartialEmoji, discord.Emoji, str]=None):
    async with ctx.channel.typing():
      if thing == None:
        url = str(ctx.author.avatar_url_as(static_format="png"))
      elif isinstance(thing, discord.PartialEmoji) or isinstance(thing, discord.Emoji):
  ...
  async def magic(self, ctx, thing: typing.Optional[typing.Union[discord.Member, discord.PartialEmoji, discord.Emoji, str]], level : float=0.6):
    async with ctx.channel.typing():
      if thing == None:
        url = str(ctx.author.avatar_url_as(static_format="png"))
      elif isinstance(thing, discord.PartialEmoji) or isinstance(thing, discord.Emoji):
  ...
  @commands.command()
  async def captcha(self, ctx, thing: typing.Union[discord.Member, discord.PartialEmoji, discord.Emoji, str]=None, *, text="enter something here"):
    async with ctx.channel.typing():
      if thing == None:
        url = str(ctx.author.avatar_url_as(static_format="png"))
      elif isinstance(thing, discord.PartialEmoji) or isinstance(thing, discord.Emoji):
  ...
  @commands.command()
  async def awareness(self, ctx, thing: typing.Union[discord.Member, discord.PartialEmoji, discord.Emoji, str]=None):
    async with ctx.channel.typing():
      if thing == None:
        url = str(ctx.author.avatar_url_as(static_format="png"))
      elif isinstance(thing, discord.PartialEmoji) or isinstance(thing, discord.Emoji):
