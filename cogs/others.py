...
class others(commands.Cog):
  ...
  async def vote(self, ctx):
    ...
    embed.add_field(name="Click here to vote", value="[Top.gg Link](https://top.gg/bot/787927476177076234/vote)\n[Bot for discord](https://botsfordiscord.com/bot/787927476177076234/vote)\n[discord bot list](https://discordbotlist.com/bots/anime-quotepic-bot/upvote)\n[botlist.space](https://botlist.space/bot/787927476177076234/upvote)\n[discord extreme list](https://discordextremelist.xyz/en-US/bots/787927476177076234)")
    embed.set_footer(text="Thank you so much <3", icon_url="https://media.tenor.com/images/c5caf59fd029c206db34cbb14956b8e2/tenor.gif")
    await ctx.send(embed=embed)
  @commands.command()
  async def source(self, ctx, *, command : str=None):
    embed=discord.Embed(color=self.bot.color)
    embed.add_field(name="source of the bot", value=f"the bot bot is currenly private source so dm {self.bot.get_user(590323594744168494).mention}")
    await ctx.send(embed=embed)
    # branch = 'main'
    # if command is None:
  ...
  async def ping(self, ctx):
    ...
    embed.add_field(name="<:stab:744345955637395586>  websocket latency", value=f"```{round(self.bot.latency * 1000)} ms ```")
    embed.add_field(name="<a:typing:597589448607399949> API latency", value=f"```{round(final_latency * 1000)} ms ```")
